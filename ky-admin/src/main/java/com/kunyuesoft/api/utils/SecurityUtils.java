package com.kunyuesoft.api.utils;
...
public class SecurityUtils
{
    ...
    public static String getUsername()
    {
        try
        {
            return ((LoginUserDTO )getLoginUser()).getUsername();
        }
        catch (Exception e)
        {
            throw new BtsException(ResultEnum.USER_ACCOUNT_IS_ERROR);
        }
    }
    ...
    public static UserInfoDTO getLoginUser()
    {
        ...
        {
            throw new BtsException(ResultEnum.USER_INFO_IS_ERROR);
        }
    }
