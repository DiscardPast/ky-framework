...
public class PermissionService
{
    ...
    public boolean hasPermi(String permission)
    {
        ...
        LoginUserDTO loginUserDTO = tokenService.getLoginUser(ServletUtils.getRequest(),LoginUserDTO.class);
    ...
    public boolean hasRole(String role)
    {
        ...
        LoginUserDTO loginUserDTO = tokenService.getLoginUser(ServletUtils.getRequest(),LoginUserDTO.class);
        if (StringUtils.isNull(loginUserDTO) || CollectionUtils.isEmpty(loginUserDTO.getUser().getRoles()))
        {
            return false;
        }
